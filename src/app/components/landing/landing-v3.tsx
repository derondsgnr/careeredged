...
function TypedText({ text, delay = 0 }: { text: string; delay?: number }) {
  ...
  return (
    <span ref={ref}>
      {displayed}
      <span className="animate-pulse" style={{ color: "#B3FF3B" }}>|</span>
    </span>
  );
}
...
export function LandingV3({ onNavigate }: LandingV3Props) {
  ...
  return (
    <div className="min-h-screen relative" style={{ background: "#08090C" }}>
      ...
      <section ref={heroRef} className="relative h-screen flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse at center, rgba(4,44,1,0.15) 0%, rgba(179,255,59,0.03) 30%, transparent 65%)",
            filter: "blur(100px)",
          }}
        />
        ...
        <motion.div className="relative z-10 text-center max-w-[1000px]">
          ...
          >
            <svg width="52" height="70" viewBox="0 0 133 180" fill="none" className="mx-auto">
              <path d="M132.41 131.992H99.5417V88.8695L93.0906 80.7536L52.8237 80.6843L52.8815 47.8164L108.964 47.932L132.41 77.3894V131.992Z" fill="rgba(179,255,59,0.3)"/>
              <path d="M88.0699 72.3383L50.8918 102.975L71.7866 128.331L108.965 97.6947L88.0699 72.3383Z" fill="rgba(179,255,59,0.3)"/>
              <path d="M132.905 179.507H35.3766L0 135.379V36.6021L36.4633 0H132.905V32.8679H50.1169L32.8563 50.1747V123.83L51.1458 146.651H132.905V179.507Z" fill="rgba(179,255,59,0.3)"/>
            </svg>
          </motion.div>
          ...
          <motion.p
            ...
            style={{ fontFamily: "'Satoshi', sans-serif", color: "#6B7280", lineHeight: 1.65 }}
          >
            <span style={{ color: "#9CA3AF" }}>This is yours.</span>
          </motion.p>
        ...
        >
          ...
          >
            <ArrowDown size={16} style={{ color: "#374151" }} />
          </motion.div>
        </motion.div>
      </section>

      {/* ═══ CH.2: THE PROBLEM ═══ */}
      <section className="py-28 lg:py-36 px-6" style={{ background: "#08090C" }}>
        <div className="max-w-[800px] mx-auto">
          <Reveal>
            <span className="text-[11px] uppercase tracking-[0.12em] block mb-8" style={{ fontFamily: "'Satoshi', sans-serif", fontWeight: 600, color: "#374151" }}>
              // The problem
            </span>
          </Reveal>
        ...
        <div className="max-w-[1100px] mx-auto">
          ...
          <Reveal delay={0.1}>
            <h2 className="mb-16" style={{
              ...
              Career<br />
              <span style={{ color: "#B3FF3B" }}>intelligence</span>
            </h2>
          </Reveal>
            ...
            {[
              ...
              <Reveal key={i} delay={i * 0.1}>
                <div
                  ...
                  onMouseEnter={(e) => { e.currentTarget.style.borderColor = "rgba(179,255,59,0.1)"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.04)"; }}
                >
                  <div className="flex items-center gap-3 mb-5">
                    <span className="text-[11px] tracking-[0.08em]" style={{ fontFamily: "'Satoshi', sans-serif", fontWeight: 600, color: "#374151" }}>
                      {item.chapter}
                    </span>
                    <div className="h-px flex-1" style={{ background: "rgba(255,255,255,0.04)" }} />
                    <item.icon size={16} style={{ color: "#6B7280" }} />
                  </div>
                  <h3 className="mb-3" style={{ fontFamily: "'Urbanist', sans-serif", fontWeight: 600, fontSize: "20px", color: "#E8E8ED" }}>
                    {item.title}
                  </h3>
                  <p className="text-[14px] leading-[1.7]" style={{ fontFamily: "'Satoshi', sans-serif", color: "#9CA3AF" }}>
                    {item.desc}
                  </p>
                </div>
              </Reveal>
      ...
      {/* ═══ CH.4: SOPHIA ═══ */}
      <section className="relative py-28 lg:py-36 px-6 overflow-hidden" style={{ background: "#08090C" }}>
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[400px] pointer-events-none"
          style={{
            background: "radial-gradient(ellipse at center, rgba(34,211,238,0.04) 0%, transparent 55%)",
            filter: "blur(80px)",
          }}
        />
        ...
        <div className="max-w-[900px] mx-auto relative z-10">
          ...
          <Reveal delay={0.1}>
            <h2 className="mb-6" style={{
              ...
              Not a chatbot.{" "}
              <span style={{ color: "#22D3EE" }}>A career guide.</span>
            </h2>
          </Reveal>

          <Reveal delay={0.15}>
            <p className="text-[16px] leading-[1.7] max-w-[600px] mb-12" style={{ fontFamily: "'Satoshi', sans-serif", color: "#9CA3AF" }}>
          ...
          <Reveal delay={0.2}>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div
                ...
                style={{ background: "rgba(18,20,26,0.6)", border: "1px solid rgba(255,255,255,0.06)" }}
              >
                <div className="flex items-center gap-2 mb-4 pb-3" style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
                  <div className="w-6 h-6 rounded-full flex items-center justify-center" style={{ background: "rgba(34,211,238,0.12)" }}>
                    <Sparkles size={11} style={{ color: "#22D3EE" }} />
                  </div>
                  <span className="text-[12px]" style={{ fontFamily: "'Satoshi', sans-serif", fontWeight: 500, color: "#22D3EE" }}>Sophia</span>
                  <div className="ml-auto w-1.5 h-1.5 rounded-full bg-[#22D3EE] animate-pulse" />
                </div>
                    ...
                    <div key={i} className={`flex ${msg.from === "user" ? "justify-end" : "justify-start"}`}>
                      <div
                        ...
                        style={{
                          ...
                          background: msg.from === "user" ? "rgba(255,255,255,0.05)" : "rgba(34,211,238,0.05)",
                          border: msg.from === "sophia" ? "1px solid rgba(34,211,238,0.08)" : "1px solid rgba(255,255,255,0.04)",
                          color: msg.from === "user" ? "#E8E8ED" : "#9CA3AF",
                        }}
                      >
                        {msg.text}
                      </div>
              ...
              <div className="flex flex-col gap-4 justify-center">
                {[
                  ...
                  <div key={i} className="flex gap-3">
                    <div className="w-5 h-5 rounded-full flex items-center justify-center shrink-0 mt-0.5" style={{ background: "rgba(34,211,238,0.08)" }}>
                      <div className="w-1.5 h-1.5 rounded-full bg-[#22D3EE]" />
                    </div>
                    <div>
                      <h4 className="text-[14px] mb-1" style={{ fontFamily: "'Urbanist', sans-serif", fontWeight: 600, color: "#E8E8ED" }}>
                        {point.title}
                      </h4>
                      <p className="text-[12px] leading-[1.65]" style={{ fontFamily: "'Satoshi', sans-serif", color: "#6B7280" }}>
                        {point.desc}
                      </p>
                    </div>
                  </div>
      ...
      <section className="py-24 lg:py-28 px-6" style={{ background: "#B3FF3B" }}>
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 lg:gap-20">
            <Reveal delay={0.1}>
              <div ref={s1.ref}>
                <span style={{ fontFamily: "'Urbanist', sans-serif", fontWeight: 700, fontSize: "clamp(48px, 8vw, 80px)", letterSpacing: "-0.04em", color: "#0A0C10", lineHeight: 1 }}>
        ...
        <div className="max-w-[800px] mx-auto">
          ...
          <Reveal delay={0.1}>
            <h2 className="mb-12" style={{
              ...
              A career ecosystem.{" "}
              <span style={{ color: "#6B7280" }}>Every stakeholder, connected.</span>
            </h2>
          </Reveal>
          ...
          <div className="flex flex-col gap-4">
            {[
              ...
              <Reveal key={i} delay={i * 0.06}>
                ...
                >
                  <span style={{ fontFamily: "'Urbanist', sans-serif", fontWeight: 600, fontSize: "17px", color: "#E8E8ED" }}>
                    {role.label}
                  </span>
                  <span
                  ...
                  <ArrowRight size={14} style={{ color: "#374151" }} className="group-hover:translate-x-1 transition-transform duration-200 shrink-0 ml-4" />
                </div>
              </Reveal>
            ))}
          </div>
      ...
      {/* ═══ CH.7: CLOSE ═══ */}
      <section className="relative py-32 lg:py-40 px-6 overflow-hidden" style={{ background: "#0A0C10" }}>
        <div
          className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[900px] h-[450px] pointer-events-none"
          style={{ background: "radial-gradient(ellipse at center, rgba(179,255,59,0.04) 0%, transparent 55%)", filter: "blur(100px)" }}
        />
        ...
        <div className="max-w-[700px] mx-auto text-center relative z-10">
          <Reveal>
            <h2 style={{
              ...
              The next chapter
              <br />
              <span style={{ color: "#B3FF3B" }}>starts here</span>
            </h2>
          </Reveal>

          <Reveal delay={0.1}>
            <p className="mt-5 text-[16px] leading-[1.7] max-w-[440px] mx-auto mb-10" style={{ fontFamily: "'Satoshi', sans-serif", color: "#6B7280" }}>
          ...
          <Reveal delay={0.2}>
            <button
              ...
              style={{ fontFamily: "'Satoshi', sans-serif", fontWeight: 600, background: "#B3FF3B", color: "#0A0C10" }}
              onMouseEnter={(e) => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 12px 40px rgba(179,255,59,0.2)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.transform = "translateY(0)"; e.currentTarget.style.boxShadow = "none"; }}
            >
              Get Your Edge
